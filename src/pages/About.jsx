...
const About = () => {
  ...
  const stats = [
    { id: 1, val: '10+', label: { ru: 'Лет на рынке', en: 'Years on market', kg: 'Жыл рынокто' } },
    { id: 2, val: '5000+', label: { ru: 'Клиентов', en: 'Clients', kg: 'Кардарлар' } },
    { id: 3, val: '50+', label: { ru: 'Брендов', en: 'Brands', kg: 'Бренддер' } },
    { id: 4, val: '24/7', label: { ru: 'Поддержка', en: 'Support', kg: 'Колдоо' } }
  ];
      ...
      <div className="about-content container">
        ...
        <div className="about-hero-glass">
          ...
          <h1 className="main-title">
            {lang === 'en' ? 'Beyond Luxury' : lang === 'kg' ? 'Люкс чегинен тышкары' : 'За пределами роскоши'}
          </h1>
