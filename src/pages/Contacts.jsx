    ...
    <div className="contact-page">
      ...
      <div className="container contact-container">
        ...
        <div className="contact-grid">
          <div className="contact-info-side">
            <div className="glass-card contact-details">
              ...
              <div className="detail-item">
                <span className="icon">📍</span>
                <p>{lang === 'en' ? 'Bishkek, Tynalieva st, 92' : 'Бишкек, ул. Тыналиева, 92'}</p>
              </div>
            </div>
            ...
            <div className="social-actions">
              <a href="https://wa.me/996552236611" target="_blank" rel="noopener noreferrer" className="social-link wa">
                <img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg" alt="WA" />
                WhatsApp
              </a>
              <a href="https://t.me/princeoftheabyss07" target="_blank" rel="noopener noreferrer" className="social-link tg">
          ...
          <div className="contact-form-side">
            <div className="glass-card luxury-form-card">
              ...
              <form onSubmit={handleSubmit} className={status === 'success' ? 'form-hidden' : ''}>
                {status === 'success' ? (
                  ...
                  <>
                    ...
                    <button type="submit" className="premium-submit-btn" disabled={status === 'sending'}>
        ...
        <div className="glass-card map-section">
          <MapContainer center={position} zoom={16} scrollWheelZoom={false} className="leaflet-map-frame">
            <TileLayer
